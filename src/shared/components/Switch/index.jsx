...
export const Switch = ({ isOn, onChange }) => {
  ...
  return (
    <button
      ...
      className={`relative h-6 w-12 cursor-pointer rounded-full border border-green-100 transition-all duration-300 ease-in-out ${isOn ? 'bg-grey400-mode1' : 'bg-grey100-mode1'}`}
    >
      <div
